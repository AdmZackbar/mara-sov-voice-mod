...
//---------------------------------------------------------------------------------------
class UISL_UICustomizeMaraSovVoice extends UIScreenListener;
...
{
    if( BodyPart.DLCName == 'MaraSovVoiceMod' )
    {
        return class'UIUtilities_Text'.static.InjectImage("img:///MaraSovVoiceModPkg.UIIcon_Awoken_Icon", 26, 26, -4) $ " ";
    }
    return "";
}
